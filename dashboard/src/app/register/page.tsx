...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      setErrorMsg('Failed to register. Email may already be in use.');
    }
  };
    ...
    <div className="min-h-screen bg-dark-950 flex items-center justify-center p-6 h-screen relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-dark-900 border border-dark-800 rounded-2xl p-8 backdrop-blur-md shadow-2xl relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-dark-400 mt-1">Start collecting analytics telemetry</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-dark-300 mb-2">Developer Name</label>
            <input
              type="text"
              value={name}
